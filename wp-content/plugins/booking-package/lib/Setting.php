    ...
    class booking_package_setting {
        ...
        public function guestsInputType(){
            ...
            $guestsInputTypeList = array(
                ...
                'guestsInCapacity' => array('key' => 'guestsInCapacity', 'name' => __('Include the number of guests in the capacity', 'booking-package'), 'value' => 'adult', 'inputLimit' => 1, 'inputType' => 'RADIO', 'valueList' => array('excluded' => __('Excluded', 'booking-package'), 'included' => __('Included', 'booking-package')), 'target' => 'day'),
        ...
        public function getElementForCalendarAccount(){
            ...
            $calendarAccount = array(
                ...
                'status' => array('key' => 'status', 'name' => __('Calendar', 'booking-package'), 'target' => 'both', 'value' => 'open', 'inputLimit' => 1, 'inputType' => 'RADIO', 'isExtensionsValid' => 0, 'option' => 0, 'valueList' => array('open' => __('Open', 'booking-package'), 'closed' => __('Closed', 'booking-package'))),
                ...
                'calendar_sharing' => array(
                    ...
                    'name' => __('Schedules sharing', 'booking-package'), 
                    'target' => 'both', 
                    'disabled' => 0, 
                    'value' => '1', 
                    'inputLimit' => 2, 
                    ...
                    'valueList' => array(
                        ...
                        1 => array(
                            'key' => 'targetSchedules',
                            'name' => __('Target calendar', 'booking-package') . ': ',
                            'value' => '0',
                            'inputType' => 'SELECT',
                            'isExtensionsValid' => 1, 
                            'actions' => null,
                ...
                'hotelCharges' => array(
                    'key' => 'hotelCharges', 
                    'name' => __('Hotel charges', 'booking-package'), 
                    'target' => 'hotel', 
                    'disabled' => 0,
                    'value' => 'false', 
                    'inputLimit' => 1, 
                ...
                'servicesFunction' => array(
                    ...
                    'name' => __('Service function', 'booking-package'), 
                    'target' => 'day', 
                    'disabled' => 0, 
                    'value' => '1', 
                    'inputLimit' => 2, 
                    ...
                    'valueList' => array(
                        ...
                        1 => array(
                            'key' => 'courseTitle',
                            'name' => __('Service name', 'booking-package') . ': ',
                            'value' => null,
                            'inputType' => 'TEXT',
                            'isExtensionsValid' => 0, 
                            'class' => 'multiple_fields_margin_top',
                ...
                'guestsBool' => array('key' => 'guestsBool', 'name' => __('Guest function', 'booking-package'), 'target' => 'day', 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'RADIO', 'isExtensionsValid' => 0, 'option' => 0, 'valueList' => array(1 => 'Enabled', 0 => 'Disabled')),
            ...
            $addNewCourse =  array(
                ...
                'stopService' => array(
                    ...
                    'valueList' => array(
                        ...
                        1 => array(
                            ...
                            'actions' => null,
                            'valueList' => array( 
                                'sameServiceIsNotStopped' => __('If the same service was in the time slot, the booking is not stopped.', 'booking-package'), 
                            ),
                        ...
                        2 => array(
                            ...
                            'actions' => null,
                            'valueList' => array( 
                                'day' => __('Per day.', 'booking-package'), 
                                'timeSlot' => __('Per time slot.', 'booking-package'), 
                            ),
                ...
                'costs' => array(
                    ...
                    'valueList' => array(
                        0 => array(
                            'key' => 'cost_1',
                            'name' => __(/**'Cost 1'**/ 'Standard Price', 'booking-package'),
                            'value' => null,
                            'inputType' => 'TEXT',
                            'isExtensionsValid' => 0, 
                            'actions' => null,
                ...
                'options' => array(
                    ...
                    'cost_1' => __(/**'Cost 1'**/ 'Standard Price', 'booking-package'), 
        ...
        **/
                    ...
                    if ( $key === 'expiration_date_for_subscriptions' ) {
                        ...
                        if ( is_numeric($value) === false ) {
                            ...
                            if (intval($value) !== 0) {
                                ...
                                $customerDetails = $this->updatePaidSubscription();
                                if (get_option('_' . $this->prefix . 'expiration_date_for_subscriptions') === false) {
                                    
                                    add_option('_' . $this->prefix . 'expiration_date_for_subscriptions', $this->encryptValue($value));
                                    
                                } else {
                                    
                                    update_option('_' . $this->prefix . 'expiration_date_for_subscriptions', $this->encryptValue($value));
		...
		public function setSubscribeSite() {
		    
		    $unique = wp_hash( get_site_url() );
        ...
        public function validateWpSite($validate = true) {
            ...
            if (empty($unique)) {
                ...
                $unique = $this->setSubscribeSite();
                
            }
            
            if (wp_hash($site) !== $unique) {
                
                $unique = $this->updateSubscribeSite();
        ...
        public function getSiteStatus($countExpiration = false) {
            ...
            #$this->decryptValue($encryptedData);
        ...
        private function encryptValue($value) {
            ...
            $encryptedData = base64_encode(openssl_encrypt($value, 'AES-128-ECB', $unique, OPENSSL_RAW_DATA));
