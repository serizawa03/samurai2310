        ...
        try {
            ...
            if (request == true) {
                ...
                if (document.getElementById("bookingBlockPanel") != null) {
                    ...
                    var post = {booking_package_nonce: this._nonce, plugin_name: this._plugin_name, action: this._action, mode: object._prefix + 'getReservationData', year: year, month: month, day: 1, public: true, accountKey: accountKey};
            ...
            if(object._stripe_active == 1 && subscription.amount != 0){
                ...
                object.stripePanel(object._stripe_public_key, object._country, subscription.currency, cartPanel, subscription.plans, null, function(paymentResponse){
                    ...
                    if(token != null){
                        ...
                        var post = {booking_package_nonce: object._nonce, plugin_name: object._plugin_name, action: object._action, mode: "createCustomer", payType: paymentResponse.paymentName, payToken: token, calendarAccountKey: calendarAccount.key};
    ...
    Booking_Package.prototype.selectedServicesPanel = function(course, services, goodsList, totalCost, coursePanel, reflectGuests, showAumontOnService) {
        ...
        **/
        ...
        if (totalCost === 0) {
            ...
            var planPrices = coursePanel.querySelectorAll('.planPrice');
