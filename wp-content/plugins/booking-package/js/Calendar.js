    ...
    TAXES.prototype.createExtraChargesAndTaxesElement = function(id) {
        ...
        var object = this;
        var extraChargeName = document.createElement('div');
        extraChargeName.classList.add('name');
        var extraChargeValues = document.createElement('div');
        extraChargeValues.classList.add('value');
        
        var taxName = document.createElement('div');
        taxName.classList.add('name');
        var taxValues = document.createElement('div');
        taxValues.classList.add('value');
        
        var extraChargesAndTaxesPanel = document.createElement('div');
        extraChargesAndTaxesPanel.id = id;
        extraChargesAndTaxesPanel.classList.add('row');
        extraChargesAndTaxesPanel.appendChild(extraChargeName);
        extraChargesAndTaxesPanel.appendChild(extraChargeValues);
        extraChargesAndTaxesPanel.appendChild(taxName);
        extraChargesAndTaxesPanel.appendChild(taxValues);
            ...
            **/
            ...
            for (var i = 0; i < surchargeList.length; i++) {
                ...
                if (reflectAdditional > 1) {
                    ...
                    //reflectAdditionalPanel.textContent = '(' + format.formatCost(surcharge.taxValue, currency) + ' * ' + reflectAdditionalTitle + ')';
                    
                    var breakdownPanel = document.createElement('div');
                    breakdownPanel.classList.add('hidden_panel');
                    breakdownPanel.classList.add('breakdownPanel');
                    breakdownPanel.classList.add('breakdownPanel_' + i);
                    breakdownPanel.textContent = format.formatCost(surcharge.taxValue, currency) + ' * ' + reflectAdditionalTitle;
