...
function SCHEDULE(schedule_data, booking_package_dictionary, webApp) {
    ...
    this._selectMultipleDaysInSchedulesTab = 0;
    
    if (schedule_data.selectMultipleDaysInSchedulesTab != null) {
        
        this._selectMultipleDaysInSchedulesTab = parseInt(schedule_data.selectMultipleDaysInSchedulesTab);
        object._console.log('_selectMultipleDaysInSchedulesTab = ' + this._selectMultipleDaysInSchedulesTab);
    ...
    this.createCalendarAccountList = function(accountList, month, day, year){
        ...
        **/
        ...
        addCalendarAccountButton.onclick = function() {
            ...
            dayButton.textContent = object._i18n.get("Time Slot Bookings (e.g., hair salon, hospital)");
            ...
            hotelButton.textContent = object._i18n.get("Multi-night Bookings (e.g., accommodations like hotels)");
    ...
    this.createCalendar = function(calendarData, month, day, year, account) {
        ...
        var actionButtonsPanelForSchedules = document.createElement('div');
        actionButtonsPanelForSchedules.id = 'actionButtonsPanelForSchedules';
        calendarPanel.appendChild(actionButtonsPanelForSchedules);
        
        var multipleDaysButtonPanelForSchedules = document.createElement('div');
        multipleDaysButtonPanelForSchedules.id = 'multipleDaysButtonPanelForSchedules';
        ...
        if (document.getElementById("save_setting") == null) {
            ...
            var selectMultipleDays = document.createElement('button');
            selectMultipleDays.setAttribute('class', 'w3tc-button-save button-primary');
            selectMultipleDays.classList.add('button_margin_left_10px');
            selectMultipleDays.textContent = object._i18n.get('Select multiple days');
            ...
            if (object._selectMultipleDaysInSchedulesTab === 0) {
    ...
    this.selectMultipleDays = function(calendarData, month, day, year, calendarPanel, account) {
        ...
        var addTimeSlotsButton = document.createElement('button');
        addTimeSlotsButton.setAttribute('class', 'w3tc-button-save button-primary');
        addTimeSlotsButton.textContent = object._i18n.get('Add time slots');
        addTimeSlotsButton.disabled = true;
        ...
        clearButton.setAttribute('class', 'w3tc-button-save button-primary');
        clearButton.classList.add('button_margin_left_10px');
        clearButton.textContent = object._i18n.get('Clear');
        clearButton.disabled = true;
        ...
        clearButton.onclick = function(event) {
            ...
            for (var key in selectedDays) {
                ...
                var dayPanel = selectedDays[key];
                dayPanel.selected = 0;
                dayPanel.eventPanel.classList.remove('selectedDayPanel');
                object._console.log(dayPanel);
        ...
        closeButton.setAttribute('class', 'w3tc-button-save button-primary');
        closeButton.classList.add('button_margin_left_10px');
        closeButton.textContent = object._i18n.get('Cancel');
        ...
        messagePanel.textContent = object._i18n.get('Select multiple days to add booking time slots.');
        multipleDaysButtonPanelForSchedules.appendChild(messagePanel);
        
    }
    
    this.createSchedulesForMultipleDays = function(account, multipleDays, callback) {
        ...
        //edit_title.textContent = monthFullName[month] + " " + day + ", " + year;
        //edit_title.textContent = calendar.formatBookingDate(month, day, year, null, null, null, week, 'text');
        edit_title.textContent = object._i18n.get('Test');
        ...
        saveButton.onclick = function(event) {
            ...
            object.updateAccountSchedule(object.template_schedule_list, "addAccountSchedule", account, multipleDays, function(response) {
    ...
    this.getPublicSchedule = function(month, day, year, account, hasIncompletelySchedules, callback){
    	...
    	deleteSchedulesButton.textContent = object._i18n.get('Delete schedule');
        ...
        saveButton.onclick = function(event){
            ...
            //object.updateAccountSchedule(object.template_schedule_list, "updateAccountSchedule", account, null, callback);
            object.updateAccountSchedule(object.template_schedule_list, "updateAccountSchedule", account, null, function(response) {
    ...
    this.getTemplateSchedule = function(weekKey, account){
        ...
        saveButton.onclick = function(event){
            ...
            object.updateAccountSchedule(object.template_schedule_list, "updateAccountTemplateSchedule", account, null, function(response) {
    ...
    this.updateAccountSchedule = function(template_schedule_list, mode, account, multipleDays, callback){
    ...
    this.taxesPanel = function(taxes, account) {
    ...
    this.extraChargesPanel = function(extraCharges, account) {
        ...
        for (var key = 0; key < extraCharges.length; key++) {
            ...
            var contentPanel = document.createElement("div");
            contentPanel.setAttribute("class", "dnd_content");
            contentPanel.textContent = extraCharges[key]['name'];
        ...
        jQuery(document).on('sortstop', '#courseSort', function(){
            ...
            var sortBool = object.sortData('key', 'dnd_column', extraCharges, panel, 'changeCourseRank');
            if (sortBool === true) {
    ...
    this.syncPanel = function(ical, syncPastCustomersForIcal, icalToken, home, account, callback){
        ...
        th.setAttribute("scope", "row");
        th.textContent = object._i18n.get("Period");
    ...
    this.settingPanel = function(accountList, month, day, year, account, callback){
        ...
        if (inputTypeList.servicesFunction != null) {
            ...
            inputTypeList.servicesFunction.valueList[1].value = account.courseTitle;
            inputTypeList.servicesFunction.valueList[2].value = account.flowOfBooking;
            inputTypeList.servicesFunction.valueList[3].value = parseInt(account.hasMultipleServices);
        ...
        saveButton.onclick = function(){
            ...
            if (object._remakeBookingSchedules == 1) {
                ...
                if (oldMaxAccountScheduleDay > parseInt(post.maxAccountScheduleDay)) {
                    ...
                    confirm.dialogPanelShow(object._i18n.get("Attention"), object._i18n.get('You changed the value of "%s".', [object._i18n.get('Public days from today')]) + ' ' + object._i18n.get('Do you remake new booking schedules?'), false, 0, function(bool){
    ...
    this.addItem = function(mainPanel, mode, account, inputTypeList, calendarType, callback){
        ...
        if (mode == object._prefix + 'addCourse') {
            ...
            **/
            ...
            if (inputTypeList.servicesFunction != null) {
                ...
                inputTypeList.servicesFunction.valueList[1].value = '';
                inputTypeList.servicesFunction.valueList[2].value = 'calendar';
                inputTypeList.servicesFunction.valueList[3].value = parseInt(0);
            ...
            inputTypeList.method.actions = {
                ...
                'addition': function onclick(event) {
                    ...
                    var value = new FORMAT_COST(this._i18n, object._debug).formatCost(parseInt(inputText.value), object._currency);
    	...
    	for (var key in inputTypeList) {
            ...
            if (mode == 'addTax' && key == 'value') {
                ...
                upperPanel = document.createElement("div");
                upperPanel.setAttribute("class", "upperPanel displayFormat_extraChargeValueAndTaxValue");
        ...
        if (input['inputType'] == 'TEXT') {
            ...
            for (var i = 0; i < fields.length; i++) {
                ...
                if (field.inputType == 'CHECK') {
                    ...
                    //valueName.setAttribute("class", "radio_title");
                    valueName.textContent = field.name;
                    valueName.classList.add('multiple_fields_margin_top');
