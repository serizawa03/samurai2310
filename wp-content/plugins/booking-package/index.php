...
*/
	...
	class BOOKING_PACKAGE {
		...
		public $selectMultipleDaysInSchedulesTab = 0;
		...
		**/
		...
		public function admin_bar_menu($wp_admin_bar){
			...
			if ($displayMenu === true) {
				...
				#wp_enqueue_style( 'Control.css', plugin_dir_url( __FILE__ ).'css/Control.css', array(), $this->plugin_version);
				$title = '<span class="top_toolbar_icon"></span><span>'.__("Booking Package", 'booking-package').'</span>';
		...
		public function add_pages() {
			...
			add_menu_page($plugin_name, __('Booking Package', 'booking-package'), $editor_cap, __FILE__, array($this,'booking_package_booked_customers'), 'dashicons-calendar-alt', 26);
		...
		public function customersList($date, $unixTime, $calendarAccountList, $lists, $schedule){
			...
			if($i == 0){
				...
				print "<div class='calendarName'>".__('No visitors', 'booking-package')."</div>";
		...
		public function booking_package_front_end($atts) {
			...
			**/
			...
			$nonce_error_message .= __('Please try changing the values of "%s" and "%s" in Booking Package > %s.', 'booking-package');
			...
			$html .= '<div id="booking-package-register" class="register">' . __("Create account", 'booking-package') . '</div>';
			$html .= '<div id="booking-package-login" class="login">' . __("Sign in", 'booking-package') . '</div>';
			$html .= '<div id="booking-package-logout" class="logout hidden_panel">' . __("Sign out", 'booking-package') . '</div>';
			$html .= '<div id="booking-package-edit" class="edit">' . __("Edit My Profile", 'booking-package') . '</div>';
			$html .= '<div id="booking-package-bookedHistory" class="edit">' . __("Booking history", 'booking-package') . '</div>';
			...
			$html .= '	</div>';
			$html .= '<div id="booking-package_servicePage" class="hidden_panel"><div id="booking-package_serviceTitle" class="title borderColor">' . sprintf(__("Please select %s", 'booking-package'), $calendarAccount["courseTitle"]) . '</div><div class="list borderColor"></div></div>';
			$html .= '<div id="booking-package_serviceDetails" class="hidden_panel"><div class="title borderColor">' . sprintf(__("Your %s details", 'booking-package'), $calendarAccount["courseTitle"]) . '</div><div class="list borderColor"></div></div>';
			...
			$html .= '			<button id="returnToCalendarButton">' . __('Return', 'booking-package') . '</button>';
			$html .= '			<button id="returnToDayListButton" class="hidden_panel">' . __('Return', 'booking-package') . '</button>';
			$html .= '			<button id="returnDayButton" class="hidden_panel"></button>';
			$html .= '			<button id="nextDayButtton" class="hidden_panel"></button>';
			$html .= '			<button id="nextButton" class="right_button hidden_panel">' . __('Next', 'booking-package') . '</button>';
			$html .= '		</div>';
			$html .= '	</div>';
			...
			$html .= '			<button>' . __('Verify', 'booking-package') . '</button>';
			$html .= '		</div>';
			$html .= '	</div>';
			$html .= '</div>';
			$html .= '</div>';
				...
				if (start_booking_package.length > 1) {
					...
					for (var i = 0; i < start_booking_package.length; i++) {
						...
						if (i > 0) {
							...
							errorContent.textContent = '<?php print __('You cannot insert multiple shortcodes of the Booking Package on a single page.', 'booking-package'); ?>';
							var errorID = document.createElement('p');
							errorID.textContent = String('<?php print __('The display of the calendar with ID %s has been canceled.', 'booking-package'); ?>').replace(/%s/g, error_booking_Package_id);
				...
				<div id="member_list">
					...
					<div class="page_action_panel">
						<select id="swich_authority" class="select_limit<?php echo $swich_authority_by_hidden; ?>">
							<option value="user"><?php echo __("Booking Package", 'booking-package'); ?></option>
							<?php
		...
		public function schedule_page(){
			...
			<div id="booking_package_calendar_accounts" style='display: none;'>
					...
					<div id="tabFrame" class="hidden_panel">
						...
						<div style="overflow-x: auto;">
							<div class="menuList">
								...
								<div id="closedDaysLink" class="menuItem hidden_panel"><?php _e("Closed days", 'booking-package'); ?></div>
								...
								<div id="subscriptionsLink" class="menuItem hidden_panel"><?php _e('Subscriptions', 'booking-package'); ?></div>
					...
					<div class="edit_modal_content">
						...
						<div id="media_router_for_schedule" class="media_frame_router">
							<table class="tableNameList">
								...
								<tr>
									<th>No</th>
									<td class="timeTd"><?php _e("Time", 'booking-package'); ?></td>
									<td id="deadlineTime" class="td_width_100_px"><?php _e("Deadline time", 'booking-package'); ?></td>
									<td><?php _e("Title", 'booking-package'); ?></td>
									<td class="td_width_50_px"><?php _e("Capacities", 'booking-package'); ?></td>
									<td id="remainder" class="td_width_100_px hidden_panel"><?php _e("Remaining", 'booking-package'); ?></td>
									<td id="stop" class="td_width_50_px"><div class="deletePanel"><?php _e("Stop", 'booking-package'); ?></div></td>
									<td id="allScheduleDelete" class="td_width_50_px"><div class="deletePanel"><?php _e("Delete", 'booking-package'); ?></div></td>
								</tr>
				...
				<div id="deletePublishedSchedulesPanel" class="hidden_panel">
					...
					<div>
			            <div class="titlePanel">
			                <div class="title"><?php echo __("Delete schedules", 'booking-package'); ?></div>
			                	...
			                	<tr>
			                		...
			                		<td>
			                			...
			                			<label id="period_within_date" class="hidden_panel">
			                				...
			                				?>
			                				<!-- <span class="to"><?php echo __("To:", 'booking-package'); ?></span> -->
			                			...
			                			<p id="deletePublishedSchedules_freePlan" class="hidden_panel freePlan">
			                				<?php echo __("The selection of the date can not be done with the free plan.", 'booking-package'); ?>
			                			</p>
			                		</td>
			                	</tr>
			                	<tr>
			                		...
			                		<td>
			                			...
			                			<label><input id="action_stop" type="radio" name="type" value="stop"><?php echo __("Stop", 'booking-package'); ?></label>
			                		</td>
			                	</tr>
			                	<tr>
				...
				<div id="loadSchedulesPanel" class="hidden_panel">
					...
					<div>
			            <div class="titlePanel">
			                <div class="title"><?php echo __("Set up schedules", 'booking-package'); ?></div>
			            ...
			            <div class="inputPanel" style="border-width: 0; margin-bottom: 0;">
			                <table>
			                	...
			                	<tr>
			                		<th><label><?php echo __("Capacities", 'booking-package'); ?></label></th>
			                		<td>
							...
							<table>
								...
								<tr>
									...
									<td>
										...
										?>
										<label><input type="checkbox" name="target" class="target" value="subscriptions" checked="checked"> <?php echo __("Subscriptions", 'booking-package'); ?></label>
										<?php
				...
				<div id="selectionSchedule" class="hidden_panel">
					...
					<div>
						<div class="titlePanel">
							<div class="title"><?php echo __("Choose a schedule", 'booking-package'); ?></div>
						...
						<div class="inputPanel" style="border-width: 0; margin-bottom: 0;">
							...
							<div id="selectionSchedule_capacitys" class="selectBlock">
								<div data-key="capacitys" class="items"><?php echo __("Capacities", 'booking-package'); ?>: <span>7</span></div>
							...
							<div id="selectionSchedule_remainders" class="selectBlock">
								<div data-key="remainders" class="items"><?php echo __("Remaining", 'booking-package'); ?>: <span>7</span></div>
			...
			?>
				...
				<div id="booking_package_general_settings" class="wrap">
					...
					<div id="tabFrame">
						<div style="overflow-x: auto;">
							<div id="menuList" class="menuList">
								<div id="settingLink" class="menuItem active hidden_panel"><?php _e("Settings", 'booking-package'); ?></div>
								<div id="holidayLink" class="menuItem hidden_panel"><?php _e("Closed days", 'booking-package'); ?></div>
								<div id="nationalHolidayLink" class="menuItem hidden_panel"><?php _e("National holiday", 'booking-package'); ?></div>
								<div id="blockEmailListsLink" class="menuItem hidden_panel"><?php _e("Blocks list", 'booking-package'); ?></div>
								<div id="memberLink" class="menuItem hidden_panel"><?php _e("Users", 'booking-package'); ?></div>
								<div id="syncLink" class="menuItem hidden_panel"><?php _e("Sync", 'booking-package'); ?></div>
								<div id="cssLink" class="menuItem hidden_panel">CSS</div>
								<div id="javascriptLink" class="menuItem hidden_panel">JavaScript</div>
								<div id="subscriptionLink" class="menuItem hidden_panel"><?php _e("Paid subscription", 'booking-package'); ?></div>
							</div>
						</div>
						<div id="contentPanel" class="content">
							...
							<div id="holidayPanel" class="hidden_panel">
								<div class="title"><?php _e("Closed days", 'booking-package'); ?></div>
								<div id="holidaysCalendarPanel"></div>
							</div>
							<div id="nationalHolidayPanel" class="hidden_panel">
								<div class="title"><?php _e("National holiday", 'booking-package'); ?></div>
		...
		public function upgradeButton($isExtensionsValid = false, $daiplay = true){
			...
			echo '<form id="booking_packaeg_paid_subscription" action="https://saasproject.net/upgrade/" method="post" style="" ' . $hidden_class . '>';
		...
		public function localizeScript($mode){
			...
			if ($mode == 'booking_package_booked_customers') {
				...
				$localize_script = array(
					...
					'selectMultipleDaysInSchedulesTab' => $this->selectMultipleDaysInSchedulesTab,
				);
		...
		public function getDictionary($mode, $pluginName){
			...
			$dictionary = array(
				...
				'Please choose %s' => __('Please choose %s', 'booking-package'),
				...
				'%s remaining' => __('%s remaining', 'booking-package'),
				...
				'Add a coupon code' => __('Add a coupon code', 'booking-package'),
				'Added a coupon' => __('Added a coupon', 'booking-package'),
				...
				'Pay with Stripe' => __('Pay with Stripe', 'booking-package'),
				...
				'Pay at a convenience store with Stripe' => __('Pay at a convenience store with Stripe', 'booking-package'),
			...
			if ($mode == "booking_package_booked_customers") {
				...
				$dictionary['capacities'] = __('capacities', 'booking-package');
				...
				$dictionary['Change ranking'] = __('Change ranking', 'booking-package');
				...
				$dictionary['Delete schedules'] = __('Delete schedules', 'booking-package');
				$dictionary['Delete schedule'] = __('Delete schedule', 'booking-package');
				...
				$dictionary['Enable the guests function'] = __('Enable the guests function', 'booking-package');
				$dictionary['Enable the coupons function'] = __('Enable the coupons function', 'booking-package');
				...
				$dictionary['Number of rooms available'] = __("Number of rooms available", 'booking-package');
				$dictionary['Hotel charges'] = __("Hotel charges", 'booking-package');
				$dictionary['Last %s days'] = __("Last %s days", 'booking-package');
				$dictionary['Service function'] = __("Service function", 'booking-package');
				$dictionary['Guest function'] = __("Guest function", 'booking-package');
				$dictionary['Coupon function'] = __("Coupon function", 'booking-package');
				$dictionary['%s or %s'] = __("%s or %s", 'booking-package');
				$dictionary['You changed the value of "%s".'] = __('You changed the value of "%s".', 'booking-package');
				...
				$dictionary['Do you remake new booking schedules?'] = __('Do you remake new booking schedules?', 'booking-package');
				...
				$dictionary['My billing and payment'] = __('My billing and payment', 'booking-package');
				...
				$dictionary['Booking details'] = __('Booking details', 'booking-package');
				$dictionary['Your Booking Details'] = __('Your Booking Details', 'booking-package');
				...
				$dictionary['Choose a date'] = __('Choose a date', 'booking-package');
